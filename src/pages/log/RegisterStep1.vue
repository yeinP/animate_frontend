...
<div class="container_register">
  <div class="inner">
    <h1 class="logo">ANIMATE</h1>
  </div>
  <div class="content">
    <form id="register_form" class="form btn_fixed" @submit.prevent="submitForm">
      <div class="form_content">
        <div class="form_section">
          <div class="check_terms">
            <input type="checkbox" id="chk_all" class="chk_all_btn" v-model="allChecked" @change="toggleAllCheckboxes"/>
            <label for="chk_all"><span class="text check_all">전체 동의하기</span></label>
        ...
        <ul class="checkbox_list">
          <li class="terms_item">
            <div class="check_terms">
              <div class="check_wrap">
                <input type="checkbox" id="termsService" class="blind" v-model="checkedTerms[0] " @change="updateAllCheckboxState"/>
                <label for="termsService">
                  <em class="option point">[필수]</em>
                  <div class="text_wrap">
                    <span class="text">ANIMATE 이용약관</span>
                  </div>
                </label>
              </div>
            </div>
            <div class="terms_box" tabindex="0">
              <div class="article">
                ...
                <p class="article_text">
                  animate 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 animate 서비스의 이용과
                  관련하여 animate 서비스를 제공하는 animate 주식회사(이하 ‘animate’)와 이를 이용하는 animate 서비스 회원(이하
                  ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 animate 서비스 이용에 도움이 될 수 있는 유익한
                  정보를 포함하고 있습니다.
                </p>
                <p class="article_text">
                  animate 서비스를 이용하시거나 animate 서비스 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을
                  확인하거나 동의하게 되므로, 잠시 시간을 내시어 주의 깊게 살펴봐 주시기 바랍니다.
                </p>
              </div>
              <div class="article">
                <h3 class="article_title">다양한 서비스를 즐겨보세요.</h3>
                <p class="article_text">
                  animate 도메인의 웹사이트를 통해 정보 검색, 다른 이용자와의 커뮤니케이션, <br>
                  콘텐츠 제공, 상품 쇼핑 등 여러분의 생활에 편리함을 더할 수 있는 다양한 서비스를 제공하고 있습니다.<br>
                  여러분은 PC, 휴대폰 등 인터넷 이용이 가능한 각종 단말기를 통해 각양각색의 animate 서비스를 자유롭게
                  이용하실 수 있으며, 개별 서비스들의 구체적인 내용은 각 서비스 상의 안내, 공지사항, 도움말 등에서 쉽게 확인하실 수 있습니다.
                </p>
                <p class="article_text">
                  animate 기본적으로 여러분 모두에게 동일한 내용의 서비스를 제공합니다. 다만, '청소년보호법' 등 관련
                ...
                <p class="article_text">
                  animate 서비스에는 기본적으로 본 약관이 적용됩니다만 animate 다양한 서비스를 제공하는 과정에서 부득이 본
                  약관 외 별도의 약관, 운영정책 등을 적용하는 경우가 있습니다. 그런경우 해당 운영 회사가 정한 고유의 약관, 운영정책
                  등이 적용될 수 있습니다. 이러한 내용은 각각의 해당 서비스 초기 화면에서 확인해 주시기 바랍니다.
                </p>
              </div>
              <div class="article">
                <h3 class="article_title">회원으로 가입하시면 animate 서비스를 보다 편리하게 이용할 수 있습니다.</h3>
                <p class="article_text">
                  여러분은 본 약관을 읽고 동의하신 후 회원 가입을 신청하실 수 있으며, animate 이에 대한 승낙을 통해 회원
                  가입 절차를 완료하고 여러분께 animate 서비스 이용 계정(이하 ‘계정’)을 부여합니다. 계정이란 회원이 animate
                  서비스에 로그인한 이후 이용하는 각종 서비스 이용 이력을 회원 별로 관리하기 위해 설정한 회원 식별 단위를
                  말합니다. 회원은 자신의 계정을 통해 좀더 다양한 animate 서비스를 보다 편리하게 이용할 수 있습니다. 이와
                  관련한 상세한 내용은 <em>계정 운영정책</em> 및 고객센터 내에서 확인해 주세요.
                </p>
              </div>
              <div class="article">
                <h3 class="article_title">여러분이 제공한 콘텐츠를 소중히 다룰 것입니다.</h3>
                <p class="article_text">
                  animate 여러분이 게재한 게시물이 animate 서비스를 통해 다른 이용자들에게 전달되어 우리 모두의 삶을 더욱
                  풍요롭게 해줄 것을 기대합니다. 게시물은 여러분이 타인 또는 자신이 보게 할 목적으로 animate 서비스 상에
                  게재한 부호, 문자, 음성, 음향, 그림, 사진, 동영상, 링크 등으로 구성된 각종 콘텐츠 자체 또는 파일을
                  말합니다.
                </p>
                <p class="article_text">
                  animate 여러분의 생각과 감정이 표현된 콘텐츠를 소중히 보호할 것을 약속 드립니다. 여러분이 제작하여
                  게재한 게시물에 대한 지식재산권 등의 권리는 당연히 여러분에게 있습니다.
                </p>
                <p class="article_text">
                  한편, animate 서비스를 통해 여러분이 게재한 게시물을 적법하게 제공하려면 해당 콘텐츠에 대한 저장, 복제,
                  수정, 공중 송신, 전시, 배포, 2차적 저작물 작성(단, 번역에 한함) 등의 이용 권한(기한과 지역 제한에 정함이
                  없으며, 별도 대가 지급이 없는 라이선스)이 필요합니다.<br>
                  게시물 게재로 여러분은 animate에게 그러한 권한을 부여하게 되므로, 여러분은 이에 필요한 권리를 보유하고
                  있어야 합니다.
                </p>
                <p class="article_text">
                  animate 여러분이 부여해 주신 콘텐츠 이용 권한을 저작권법 등 관련 법령에서 정하는 바에 따라 animate
                ...
                <p class="article_text">
                  또한 여러분이 제공한 소중한 콘텐츠는 animate 서비스를 개선하고 새로운 animate 서비스를 제공하기 위해
                  인공지능 분야 기술 등의 연구 개발 목적으로 animate에서 사용될 수 있습니다. animate는
                  지속적인 연구 개발을 통해 여러분께 좀 더 편리하고 유용한 서비스를 제공해 드릴 수 있도록 최선을
                  다하겠습니다.
                </p>
                <p class="article_text">
                  animate 여러분이 자신이 제공한 콘텐츠에 대한 animate 또는 다른 이용자들의 이용 또는 접근을 보다 쉽게
                  관리할 수 있도록 다양한 수단을 제공하기 위해 노력하고 있습니다. 여러분은 animate 서비스 내에 콘텐츠 삭제,
                  비공개 등의 관리기능이 제공되는 경우 이를 통해 직접 타인의 이용 또는 접근을 통제할 수 있고, 고객센터를
                  통해서도 콘텐츠의 삭제, 비공개, 검색결과 제외 등의 조치를 요청할 수 있습니다.<br>
                  다만, 일부 animate 서비스의 경우 삭제, 비공개 등의 처리가 어려울 수 있으며, 이러한 내용은 각 서비스 상의
              ...
              <div class="article">
                ...
                <p class="article_text">
                  animate 서비스의 원활한 제공을 위하여 회원이 동의한 목적과 범위 내에서만 개인정보를 수집∙이용하며,
                  개인정보 보호 관련 법령에 따라 안전하게 관리합니다. animate 이용자 및 회원에 대해 관련 개인정보를
                  안전하게 처리하기 위하여 기울이는 노력이나 기타 상세한 사항은 개인정보 처리방침에서 확인하실
                  수 있습니다.
                </p>
                <p class="article_text">
                  animate 여러분이 서비스를 이용하기 위해 일정 기간 동안 로그인 혹은 접속한 기록이 없는 경우, 전자메일,
              ...
              <div class="article">
                ...
                <p class="article_text">
                  ...
                  있습니다. animate 이에 대한 문제 해결을 위해 ‘정보통신망 이용촉진 및 정보보호 등에 관한 법률’ 및
                  ‘저작권법’ 등을 근거로 권리침해 주장자의 요청에 따른 게시물 게시중단, 원 게시자의 이의신청에 따른 해당
                  게시물 게시 재개 등을 내용으로 하는 게시중단요청서비스를 운영하고
                  있습니다. 보다 상세한 내용 및 절차는 고객센터 내 게시중단요청서비스 소개를 참고해 주세요.
                </p>
                <p class="article_text">
                  한편, animate 서비스를 통해 타인의 콘텐츠를 이용한다고 하여 여러분이 해당 콘텐츠에 대한 지식재산권을
                  보유하게 되는 것은 아닙니다. 여러분이 해당 콘텐츠를 자유롭게 이용하기 위해서는 그 이용이 저작권법 등
                  관련 법률에 따라 허용되는 범위 내에 있거나, 해당 콘텐츠의 지식재산권자로부터 별도의 이용 허락을 받아야
                  하므로 각별한 주의가 필요합니다.
                </p>
                <p class="article_text">
                  animate 여러분이 animate 서비스를 마음껏 이용할 수 있도록 여러분께 animate 서비스에 수반되는 관련
                  소프트웨어 사용에 관한 이용 권한을 부여합니다. 이 경우 여러분의 자유로운 이용은 animate 제시하는 이용
              ...
              <div class="article">
                <h3 class="article_title">animate 서비스 이용과 관련하여 몇 가지 주의사항이 있습니다.</h3>
                <p class="article_text">
                  animate 여러분이 animate 서비스를 자유롭고 편리하게 이용할 수 있도록 최선을 다하고 있습니다. 다만,
                  여러분이 animate 서비스를 보다 안전하게 이용하고 animate 서비스에서 여러분과 타인의 권리가 서로 존중되고
                  보호받으려면 여러분의 도움과 협조가 필요합니다. 여러분의 안전한 서비스 이용과 권리 보호를 위해 부득이
                  아래와 같은 경우 여러분의 게시물 게재나 animate 서비스 이용이 제한될 수 있으므로, 이에 대한 확인 및
                  준수를 요청 드립니다.
                </p>
                <ul class="article_text">
                  ...
                  <li class="article_text_list">
                    자동화된 수단을 활용하는 등 animate 서비스의 기능을 비정상적으로 이용하여 게재된 게시물, animate 각 개별
                    서비스의 제공 취지와 부합하지 않는 내용의 게시물은 다른 이용자들의 정상적인 animate 서비스 이용에
                    불편을 초래하고 더 나아가 animate 원활한 서비스 제공을 방해하므로 역시 제한될 수 있습니다. 기타
                    제한되는 게시물에 관한 상세한 내용은 <em>게시물 운영정책</em> 및 각 개별 서비스에서의 약관, 운영정책
                    등을 참고해 주시기 바랍니다.
                  </li>
                  <li class="article_text_list">
                    animate 사전 허락 없이 자동화된 수단(예: 매크로 프로그램, 로봇(봇), 스파이더, 스크래퍼 등)을 이용하여
                    animate 서비스 회원으로 가입을 시도 또는 가입하거나, animate 서비스에 로그인을 시도 또는 로그인하거나,
                    animate 서비스 상에 게시물을 게재하거나, animate 서비스를 통해 커뮤니케이션하거나(예: 전자메일, 쪽지
                    등), animate 서비스에 게재된 회원의 아이디(ID), 게시물 등을 수집하거나, animate 검색 서비스에서 특정
                    질의어로 검색하거나 혹은 그 검색결과에서 특정 검색결과를 선택(이른바 ‘클릭’)하는 등 이용자(사람)의
                    실제 이용을 전제로 하는 animate 서비스의 제공 취지에 부합하지 않는 방식으로 animate 서비스를 이용하거나
                    이와 같은 animate 서비스에 대한 어뷰징(남용) 행위를 막기 위한 animate 기술적 조치를 무력화하려는
                    일체의 행위(예: IP를 지속적으로 바꿔가며 접속하는 행위, Captcha를 외부 솔루션 등을 통해 우회하거나
                    무력화 하는 행위 등)를 시도해서는 안 됩니다.
                  </li>
                  <li class="article_text_list">
                    animate 동의 없이 자동화된 수단에 의해 animate 서비스 상에 광고가 게재되는 영역 또는 그 밖의 영역에
                    부호, 문자, 음성, 음향, 그림, 사진, 동영상, 링크 등으로 구성된 각종 콘텐츠 자체 또는 파일을 삽입해서는
                    안 됩니다. 또한, animate 서비스 또는 이에 포함된 소프트웨어를 복사, 수정할 수 없으며, 이를 판매, 양도,
                    대여 또는 담보로 제공하거나 타인에게 그 이용을 허락해서는 안 됩니다. animate 서비스에 포함된
                    소프트웨어를 역 설계, 소스코드 추출 시도, 복제, 분해, 모방, 기타 변형하는 등의 행위도 금지됩니다(다만,
                    오픈소스에 해당되는 경우 그 자체 조건에 따릅니다). 그 밖에 바이러스나 기타 악성 코드를 업로드하거나
                    animate 서비스의 원활한 운영을 방해할 목적으로 서비스 기능을 비정상적으로 이용하는 행위 역시
                    금지됩니다.
                  </li>
                </ul>
                <p class="article_text">
                  animate 본 약관의 범위 내에서 게시물 운영정책, 각 개별 서비스에서의 약관 또는 운영정책, 각 서비스 상의
              ...
              <div class="article">
                ...
                <p class="article_text">
                  animate 다양한 정보와 의견이 담긴 여러분의 콘텐츠를 소중히 다룰 것을 약속 드립니다만, 여러분이 게재한
                  게시물이 관련 법령, 본 약관, 게시물 운영정책, 각 개별 서비스에서의 약관, 운영정책 등에 위배되는 경우,
                  부득이 이를 비공개 또는 삭제 처리하거나 게재를 거부할 수 있습니다. 다만, 이것이 animate 모든 콘텐츠를
                  검토할 의무가 있다는 것을 의미하지는 않습니다.
                </p>
                <p class="article_text">
                  또한 여러분이 관련 법령, 본 약관, 계정 및 게시물 운영정책, 각 개별 서비스에서의 약관, 운영정책 등을
                  준수하지 않을 경우, animate 여러분의 관련 행위 내용을 확인할 수 있으며, 그 확인 결과에 따라 animate
                  서비스 이용에 대한 주의를 당부하거나, animate 서비스 이용을 일부 또는 전부, 일시 또는 영구히 정지시키는
                  등 그 이용을 제한할 수 있습니다. 한편, 이러한 이용 제한에도 불구하고 더 이상 animate 서비스 이용계약의
              ...
              <div class="article">
                <h3 class="article_title">animate 잘못은 animate 책임집니다.</h3>
                <p class="article_text">
                  animate 여러분이 animate 서비스를 이용함에 있어 animate 고의 또는 과실로 인하여 손해를 입게 될 경우
                  관련 법령에 따라 여러분의 손해를 배상합니다. 다만, 천재지변 또는 이에 준하는 불가항력으로 인하여
                  animate 서비스를 제공할 수 없거나 이용자의 고의 또는 과실로 인하여 서비스를 이용할 수 없어 발생한
                  손해에 대해서 animate 책임을 부담하지 않습니다.
                </p>
                <p class="article_text">
                  그리고 animate 손해배상책임을 부담하는 경우에도 통상적으로 예견이 불가능하거나 특별한 사정으로 인한
                  특별 손해 또는 간접 손해, 기타 징벌적 손해에 대해서는 관련 법령에 특별한 규정이 없는 한 책임을 부담하지
                  않습니다.
                </p>
                <p class="article_text">
                  한편, animate 서비스를 매개로 한 여러분과 다른 회원 간 또는 여러분과 비회원 간의 의견 교환, 거래 등에서
                  발생한 손해나 여러분이 서비스 상에 게재된 타인의 게시물 등의 콘텐츠를 신뢰함으로써 발생한 손해에
                  대해서도 animate 특별한 사정이 없는 한 이에 대해 책임을 부담하지 않습니다.
                </p>
              </div>
              <div class="article">
                <h3 class="article_title">언제든지 animate 서비스 이용계약을 해지하실 수 있습니다.</h3>
                <p class="article_text">
                  animate 참 안타까운 일입니다만, 회원은 언제든지 animate 서비스 이용계약 해지를 신청하여 회원에서
                  탈퇴할 수 있으며, 이 경우 animate 관련 법령 등이 정하는 바에 따라 이를 지체 없이 처리하겠습니다.
                </p>
                <p class="article_text">
                  animate 서비스 이용계약이 해지되면, 관련 법령 및 개인정보처리방침에 따라 animate 해당 회원의 정보를
              ...
              <div class="article">
                ...
                <p class="article_text">
                  animate 연중 무휴, 1일 24시간 안정적으로 서비스를 제공하기 위해 최선을 다하고 있습니다만, 컴퓨터, 서버
                  등 정보통신설비의 보수점검, 교체 또는 고장, 통신두절 등 운영상 상당한 이유가 있는 경우 부득이 서비스의
                  전부 또는 일부를 중단할 수 있습니다.
                </p>
                <p class="article_text">
                  한편, animate 서비스 운영 또는 개선을 위해 상당한 필요성이 있는 경우 서비스의 전부 또는 일부를 수정,
                  변경 또는 종료할 수 있습니다. 무료로 제공되는 서비스의 전부 또는 일부를 수정, 변경 또는 종료하게 된 경우
                  관련 법령에 특별한 규정이 없는 한 별도의 보상을 하지 않습니다.
                </p>
                <p class="article_text">
                  이 경우 animate 예측 가능한 경우 상당기간 전에 이를 안내하며, 만약 예측 불가능한 경우라면 사후 지체
              ...
              <div class="article">
                ...
                <p class="article_text">
                  animate 서비스 이용에 필요한 주요사항을 적시에 잘 안내해 드릴 수 있도록 힘쓰겠습니다. 회원에게 통지를
                  하는 경우 전자메일, 서비스 내 알림 또는 기타 적절한 전자적 수단을 통해 개별적으로 알려 드릴 것이며, 다만
                  회원 전체에 대한 통지가 필요할 경우엔 7일 이상 animate 도메인의 웹사이트 및
                  응용프로그램(어플리케이션, 앱) 초기 화면 또는 공지사항 등에 관련 내용을 게시하도록 하겠습니다.
                </p>
                <p class="article_text">
                  animate 여러분의 소중한 의견에 귀 기울이겠습니다. 여러분은 언제든지 고객센터를 통해 서비스 이용과
                  관련된 의견이나 개선사항을 전달할 수 있으며, animate는 합리적 범위 내에서 가능한 그 처리과정 및 결과를
              ...
              <div class="article">
                ...
                <p class="article_text">
                  animate 본 약관의 내용을 여러분이 쉽게 확인할 수 있도록 서비스 초기 화면에 게시하고 있습니다.
                </p>
                <p class="article_text">
                  animate 수시로 본 약관, 계정 및 게시물 운영정책을 개정할 수 있습니다만, 관련 법령을 위배하지 않는 범위
                ...
                <p class="article_text">
                  animate 변경된 약관을 게시한 날로부터 효력이 발생되는 날까지 약관 변경에 대한 여러분의 의견을
                  기다립니다. 위 기간이 지나도록 여러분의 의견이 animate 접수되지 않으면, 여러분이 변경된 약관에 따라
                  서비스를 이용하는 데에 동의하는 것으로 간주됩니다. 네이animate버로서는 매우 안타까운 일이지만, 여러분이 변경된
                  약관에 동의하지 않는 경우 변경된 약관의 적용을 받는 해당 서비스의 제공이 더 이상 불가능하게 될 수
                  있습니다.
                </p>
                <p class="article_text">
                  animate 서비스에는 기본적으로 본 약관이 적용됩니다만, 부득이 각 개별 서비스의 고유한 특성을 반영하기 위해
                ...
                <p class="article_text">
                  본 약관은 한국어를 정본으로 합니다. 본 약관 또는 animate 서비스와 관련된 여러분과 animate 관계에는
                  대한민국의 법령이 적용됩니다. 그리고 본 약관 또는 animate 서비스와 관련하여 여러분과 animate 사이에 분쟁이
                  발생할 경우, 그 분쟁의 처리는 대한민국 '민사소송법'에서 정한 절차를 따릅니다.
                </p>
                <ul class="article_text">
                  <li class="article_text_list">공지 일자: 2024년 2월 15일</li>
                  <li class="article_text_list">적용 일자: 2024년 2월 30일</li>
                </ul>
                <p class="article_text">
                  animate 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터로 문의 주시기 바랍니다.
                </p>
              </div>
              </div>
          </li>
          <li class="terms_item" >
            <div class="check_terms">
              <div class="check_wrap">
                <input type="checkbox" id="termsPrivacy" class="blind" v-model="checkedTerms[1]"  @change="updateAllCheckboxState"/>
            ...
            <div class="terms_box" tabindex="0">
              ...
              <div class="article">
                <p class="article_text">
                  개인정보보호법에 따라 animate 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및
              ...
              <div class="article">
                ...
                <p class="article_text">
                  이용자는 회원가입을 하지 않아도 정보 검색  등 대부분의 animate 서비스를 회원과 동일하게 이용할
                  수 있습니다. 이용자가 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, animate 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
                </p>
                <div class="clause">
                  <h4 class="clause_title">회원가입 시점에 animate 이용자로부터 수집하는 개인정보는 아래와 같습니다.</h4>
                  <ul class="sections">
                  ...
                  <p class="clause_text">
                    ...
                    - animate 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.</p> <br><br>
                  ...
                  animate 제공하는 위치기반 서비스에 대해서는 'animate 위치기반서비스 이용약관'에서 자세하게 규정하고 있습니다.<br>
                  ...
                  <ul class="sections">
                    ...
                    <li class="sections_section">
                      - 서비스 이용기록이란?<br>
                      animate 접속 일시, 이용한 서비스 목록 및 서비스 이용 과정에서 발생하는 정상 또는 비정상 로그 일체 등을 의미합니다.
                    </li>
                    <li class="sections_section">
                      - 기기정보란?<br>
                      본 개인정보처리방침에 기재된 기기정보는 생산 및 판매 과정에서 기기에 부여된 정보뿐 아니라, 기기의 구동을 위해 사용되는 S/W를 통해 확인 가능한 정보를 모두 일컫습니다.
                      OS(Windows, MAC OS 등) 설치 과정에서 이용자가 PC에 부여하는 컴퓨터의 이름, PC에 장착된 주변기기의 일련번호, 스마트폰의 통신에 필요한 고유한 식별값(IMEI, IMSI), AAID 혹은 IDFA, 설정언어 및 설정 표준시, USIM의 통신사 코드 등을 의미합니다. 단, animate IMEI와 같은 기기의 고유한 식별값을 수집할 필요가 있는 경우, 이를 수집하기 전에 animate 원래의 값을 알아볼 수 없는 방식으로 암호화 하여 식별성(Identifiability)을 제거한 후에 수집합니다.
                    </li>
                    <li class="sections_section">
                      - 쿠키(cookie)란?<br>
                      ...
                      다만, 쿠키의 저장을 거부할 경우에는 로그인이 필요한 animate 일부 서비스의 이용에 불편이 있을 수 있습니다.
                    </li>
                  </ul>
                </div>
              </div>
              <div class="article">
                ...
                <p class="article_text">
                  animate 및 animate 관련 제반 서비스(모바일 웹/앱 포함)의 회원관리, 서비스 개발・제공 및 향상, 안전한
                ...
                <ul class="sections">
                  ...
                  <li class="sections_section">
                    - 법령 및 animate 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의
                ...
                <div class="clause">
                  ...
                  <ul class="sections">
                    <li class="sections_section">
                      ...
                      법정대리인DI) : 탈퇴일로부터 6개월 보관 <br>탈퇴한 이용자의 휴대전화번호(휴대전화 인증 시), DI(아이핀 인증 시): 탈퇴일로부터 6개월 보관(복호화가 불가능한 일방향 암호화(해시)하여 보관)
                    </li>
                    <li class="sections_section">
                      - animate 서비스 제공을 위한 본인 확인<br> 통신사 정보 : 수집 시점으로부터 1년 보관
                    </li>
                  </ul>
                </div>
                <div class="clause">
                  <h4 class="clause_title">
                    ...
                    일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다. animate 이 기간 동안 법령의 규정에 따라
          ...
          <li class="terms_item"  >
            <div class="check_terms">
              <div class="check_wrap">
                <input type="checkbox" id="termsLocation" class="blind" v-model="checkedTerms[2]"  @change="updateAllCheckboxState"/>
                <label for="termsLocation">
                  <em class="option">[선택]</em>
                  <div class="text_wrap">
                    <span class="text">위치기반서비스 이용약관</span>
                    <a href="https://policy.naver.com/policy-mobile/term.html?type=3" class="link_arrow">전체</a>
                  </div>
                </label>
              </div>
            </div>
            <div class="terms_box" tabindex="0">
              ...
              <div class="article">
                <p class="article_text">
                  위치기반서비스 이용약관에 동의하시면,
                  <strong>위치를 활용한 광고 정보 수신 등을 포함하는 animate 위치기반 서비스</strong>를 이용할 수 있습니다.
                </p>
              </div>
              <div class="article">
                <h3 class="article_title">제 1 조 (목적)</h3>
                <p class="article_text">
                  이 약관은 animate 주식회사 (이하 “회사”)가 제공하는 위치기반서비스와 관련하여 회사와 개인위치정보주체와의
              ...
              <div class="article">
                ...
                <ol class="section">
                  <li>
                    ① 회사는 만 14세 미만 아동으로부터 개인위치정보를 수집ㆍ이용 또는 제공하고자 하는 경우에는 만 14세 미만
              ...
              <div class="article">
                ...
                <ol class="section">
                  ...
                  <li>
                    ...
                    단, ‘GeoTagging’ 서비스와 같이 이용자가 게시물, 콘텐츠와 함께 개인위치정보를 animate 서비스에 게시 또는
          ...
          <li class="terms_item" >
            <div class="check_terms">
              <div class="check_wrap">
                <input type="checkbox" id="termsPri" class="blind" v-model="checkedTerms[3]"  @change="updateAllCheckboxState"/>
                <label for="termsPri">
                  <em class="option">[선택]</em>
                  <div class="text_wrap">
                    <span class="text">개인정보 수집 및 이용</span>
      ...
      <div class="btn_submit_wrap">
        <button type="button" id="btnAgree" class="btn_submit" v-if="!allChecked && !isAtLeastOneOptionalChecked" style="background-color: #d6d6d6; color:#929294">필수 항목에 동의해 주세요</button>
        <button type="button" id="btnAgree" class="btn_submit" v-else @click="goNextStep">다음</button>
      </div>
    </form>
  </div>
</div>
...
export default {
  ...
  data() {
    return {
      allChecked: false,
      checkedTerms: [false, false, false, false], // 초기값은 약관 개수에 맞게 수정
    };
  },
  computed: {
    isAtLeastOneOptionalChecked() {
      return this.checkedTerms.slice(0,2).every(item => item);
    }
  },
  ...
  methods: {
    toggleAllCheckboxes() {
      if (this.allChecked) {
        this.checkedTerms = this.checkedTerms.map(() => true);
      } else {
        this.checkedTerms = this.checkedTerms.map(() => false);
      }
    },
    updateAllCheckboxState() {
      this.allChecked = this.checkedTerms.every(item => item);
    },
